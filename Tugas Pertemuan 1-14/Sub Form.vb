Public Class Form1
    ...
    Private Sub PercabanganSelectCaseToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles PercabanganSelectCaseToolStripMenuItem.Click
        Form_Practice2.ShowDialog()
    End Sub

    Private Sub SelectCaseToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SelectCaseToolStripMenuItem.Click
        Form_Select_Case4.ShowDialog()
    End Sub

    Private Sub NilaiDanGajiToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles NilaiDanGajiToolStripMenuItem.Click
        Form_Select_Case_Nilai.ShowDialog()
